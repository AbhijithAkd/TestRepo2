...
export default class EmailInput extends LightningElement {
    ...
    connectedCallback(){
        if(typeof this.getValueFromParent!=undefined)
        {
        this.selectedValuesMap.set(this.getValueFromParent, this.getValueFromParent);
        this._selectedValues=[...this.selectedValuesMap.keys()];
        //this.selectedValues=this.getValueFromParent
    }
}
    get selectedValues() {
    ...
    onSelect(event) {
        ...
        console.log('Mappp'+this.selectedValuesMap)
        this.selectedValues = [...this.selectedValuesMap.keys()];
